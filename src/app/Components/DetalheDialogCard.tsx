...
export default function DetalheCardDialog({
    ...
    return (
        <div className="fixed inset-0 bg-[rgba(0,0,0,0.75)] flex justify-center items-center z-50 overflow-auto">
            <div className="bg-white rounded-xl max-h-[90vh] overflow-y-auto p-6 w-[90%] max-w-md">
                ...
                <p className="text-sm text-gray-600 mb-1">Criado em: {new Date(card.createdAt).toLocaleDateString('pt-BR')}</p>
                <p className="text-sm text-gray-600 mb-4">Autor: {card.autorLogin}</p>
